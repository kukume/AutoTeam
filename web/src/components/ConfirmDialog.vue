          ...
          <div v-else-if="mode === 'phone-send'" class="px-6 py-5">
            ...
            <div class="grid grid-cols-2 gap-3">
              <button
                ...
                class="flex flex-col items-center justify-center gap-1.5 px-4 py-4 rounded-xl border-2 transition-all text-sm font-medium"
              ...
              <button
                ...
                @mouseout="e => { e.currentTarget.style.background = ''; e.currentTarget.style.borderColor = 'var(--card-border)' }"
              >
                <svg class="w-6 h-6" style="color: #25D366;" viewBox="0 0 24 24" fill="currentColor">
